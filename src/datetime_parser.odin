...
parse_time_only :: proc(time_str: string) -> (string, bool) {
	...
	result := fmt.aprintf("%04d-%02d-%02d %02d:%02d:00", year, int(month), day, hour, minute, allocator=context.temp_allocator)
...
parse_full_datetime :: proc(datetime_str: string) -> (string, bool) {
	...
	result := fmt.aprintf("%04d-%02d-%02d %02d:%02d:%02d", year, month, day, hour, minute, second, allocator=context.temp_allocator)
